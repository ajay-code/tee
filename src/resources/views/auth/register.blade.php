                                    ...
                                    <div class=" form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                                        <div class="">
                                            ...
                                            value="{{ old('sex') }}" >
                                                ...
                                                >@lang('common.male')</option>
                                                <option value="female"
                                                {{
                                                    old('sex') == 'female' ? "selected":"" }}
                                                >@lang('common.female')</option>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="checkbox has-error">
                                <label>
                                    ...
                                    <p><a href="#" data-toggle="modal" data-target="#terms-and-conditions">
                                        @lang('form.agree_with_terms_and_conditions')
                                    </a></p>
                                </label>
...
<!-- Modal -->
@include('layouts.partials.models.form-terms')
