<div class="form-group {{ $errors->has('can_view_posts') ? 'has-error' : ''}}">
    {!! Form::label('can_view_posts', 'Can View Posts', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('can_view_friends', 'Can View Friends', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('can_send_request', 'Can Send Request', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('can_send_message', 'Can Send Message', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
