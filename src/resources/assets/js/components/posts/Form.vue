		...
		<form id="post-form" action="/posts" method="post" class="form-horizontal" enctype="multipart/form-data" @submit.prevent="post">
			...
			<div class="col-md-10">
				<div class="form-group ">
			        <textarea v-model="form.body" name="body" cols="30" rows="6" id="body" class=" text-post" placeholder="Whats on your mind...."></textarea>
				</div>
			</div>
			<div class="col-md-2">
			...
			<div class="col-md-12">
				<label id="photo-label" for="photo"><i class="fa fa-camera"></i> <span class="label-text">Upload Photo</span></label>
				<input id="photo" @change="processFile($event)" class="display-none" name="image" type="file" accept="image/*">
			</div>
            <div id="preview" class="col-md-12 hide">
